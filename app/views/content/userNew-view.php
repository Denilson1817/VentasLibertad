<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle"><i class="fas fa-user-tie fa-fw"></i> &nbsp; Módulo para registrar nuevo usuario</h2>
</div>
			...
			<div class="column">
				<div class="control">
					...
					<input class="input" type="password" name="usuario_clave_1" 
						...
						title="La contraseña debe tener al menos 7 caracteres, debe incluir letras, números y los símbolos $ @ . -" >
					<p class="help is-info">La contraseña debe tener al menos 7 caracteres, debe incluir letras, números y los símbolos $ @ . -</p>
				</div>
			</div>
			<div class="column">
				<div class="control">
					...
					<p class="help is-info">Debe coincidir con la contraseña ingresada anteriormente.</p>
				</div>
			</div>
		</div>
